...
public class PartiHub {
    ...
    public PartiHub() {
        ...
        listaPartido.add(new Partido("14/02","20:45", paris, barcelona));
        ...
        listaPartido.add(new Partido("14/02","20:45", benfica, dormunt));
        ...
        listaPartido.add(new Partido("15/02","20:45", bayern, arsenal));
        ...
        listaPartido.add(new Partido("15/02","20:45", madrid, napoles));
    }
